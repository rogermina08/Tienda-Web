<%-- 
    Document   : index
    Created on : 7/10/2021, 03:28:56 PM
    Author     : Lenovo
--%>
...
<html>
    ...
    <body>
        ...
        <div class="card text-center">
            ...
            <br>
            <h4 class="card-title">"El secreto del éxito es la constancia en los propósitos"</h4
            <h6 class="card-title">"Benjamin Disraeli"</h6>
            <br><br><br><br>
            <h4 class="card-title">Bienvenid@s!</h4>
            <br>
            <a href="menuPrincipal.jsp" class="btn btn-primary">Iniciar</a>
