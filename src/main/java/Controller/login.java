...
public class login extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            ArrayList <CompraVentaCrud> compraventas = new ArrayList<CompraVentaCrud>();
            CompraVentaCrud compraventa;

            CompraVentaCrud objcompraventacrud = new CompraVentaCrud();
            compraventas = objcompraventacrud.listarCompraVentaN();
            if (compraventas != null){
                request.setAttribute("CompraVentas",compraventas);
